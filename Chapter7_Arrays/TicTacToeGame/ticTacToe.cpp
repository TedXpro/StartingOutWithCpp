...
void acceptPosition(int[]);
bool testValidity(int[]);
bool isNotTaken(char[][3], int[]);
bool testDiagonal(char[][3]);
bool testRow(char[][3]);
bool testColumn(char[][3]);
bool testWinner(char [][3]);
void display(char[][3]);
 ...
 *
 * @param numbers will hold the position of the matrix.
 */
 ...
 *
 * @param numbers holds the position entered by the user.
 *
 * @return 1 if the entered position is between 0 and 2.
 * @return 0 if the entered position is not between 0 and 2.
 */
 ...
 *
 * @param objects holds the objects array.
 * @param positions holds the position given by the user.
 *
 * @return 1 is the position is not taken.
 * @return 0 is the position is taken.
 */
 ...
 *
 * @param objects will hold the objects.
 *
 ...
 * @param objects will hold the objects.
 *
 * @return 1 if the position is not taken.
 * @return 0 is the position is taken.
 */
 ...
 *
 * @param objects will hold the objects array.
 *
 * @return 1 if the position is taken
 * @return 0 if the position is not taken.
 */
